...
/*body
    ...
    <form method="post" action="print_staff.php">
...
<td> <input type="date" name="txtEndDate"></td>
    ...
    <tr><td><a style="position:relative;top:60px;left:150px;" href="allstaff.php"><b><font size="4" color="black">View all Staff</font></b></a></td></tr>
      <tr>
      <tr>
<td><input style="position:relative;top:80px;left:150px;" type="submit" name="search" value="Generate"></td>
</tr>
       </table>
</form>
		</div> 
