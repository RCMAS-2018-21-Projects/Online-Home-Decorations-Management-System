...
<div style="position:relative;left:550px;top:10px;">
    <form action="search_staffs.php" method="POST" >
<input type="text" name="s_name" placeholder="Search By name">
	...
	<div class="checkout-right">
										<h1 style="position:relative;left:520px;top:120px;font-weight:bold;">STAFF INFORMATION</h1>
				...
				<table border="1" style="position:relative;width:1000px;left:150px;top:160px;">
					...
					<?php
					$sql="select * from staffreg where name='$name'";
					$tbl=getDatas($sql);
					...
					<td class="invert"><?php echo $tbl[$i][8];?></td>
                        ...
                        <td><a href="edit_staff.php?id=<?php echo $tbl[$i][0];?>"><font color="LightCoral">Edit</font></a></td>
						</tr>
