...
<div class="heading"><br><br>
    <h1 style="position:relative;left:580px;top:120px;font-weight:bold;">EDIT CATEGORY</h1></div>

<form action="" method="POST" >
            <table  style="position: relative;width:1000px;left:300px;top:160px">
...
<?php
    ...
    $sql="select * from category where cname='$b'";	
	$tbl=getDatas($sql);
    $em1=$tbl[0][1];
    if($em1=='')
    {
