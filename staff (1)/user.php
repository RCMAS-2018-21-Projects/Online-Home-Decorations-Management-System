...
<table style="position:relative;top:5px;left:420px;">
    
<h1 style="position:relative;left:420px;top:60px;"> CUSTOMER REGISTRATION</h1>
...
$( "#myform" ).validate({
  rules: {
    ...
    <td>Confirm Password</td>
        <td><input type="text" name="confirmpassword" id="cpwd"onblur="Validatecpassword()";></td> 
    </tr>
...
if(isset($_POST['name'])){
	...
	$sql="insert into userreg values(NULL,'$a','$b','$c','$d','$e','$f','$g')";
	setDatas($sql);
